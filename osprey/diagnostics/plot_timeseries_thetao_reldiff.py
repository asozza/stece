...
def drawing(figname):
    ...
    timeseries(expname='FE01', startyear=1990, endyear=2139, varlabel='thetao', reader='post', metric='reldiff', color='red', linestyle='-', label='EOF-T')
    timeseries(expname='FE02', startyear=1990, endyear=2089, varlabel='thetao', reader='post', metric='reldiff', color='blue', linestyle='-', label='EOF-TS')
