...
def drawing(figname):
    ...
    timeseries(expname='lfr0', startyear=1990, endyear=2399, varlabel='so', reader='post', timeoff=0, color='lightcoral', linestyle='-', label='lfr0')
    timeseries(expname='lfr1', startyear=1990, endyear=2390, varlabel='so', reader='post', timeoff=410, color='red', linestyle='-', label='lfr1')
    timeseries(expname='lfr2', startyear=1990, endyear=2349, varlabel='so', reader='post', timeoff=811, color='orange', linestyle='-', label='lfr2')
    timeseries(expname='lfr3', startyear=1990, endyear=2349, varlabel='so', reader='post', timeoff=1171, color='green', linestyle='-', label='lfr3')
    timeseries(expname='lfr4', startyear=1990, endyear=2349, varlabel='so', reader='post', timeoff=1531, color='darkseagreen', linestyle='-', label='lfr4')
    timeseries(expname='lfr5', startyear=1990, endyear=2349, varlabel='so', reader='post', timeoff=1891, color='cornflowerblue', linestyle='-', label='lfr5')
