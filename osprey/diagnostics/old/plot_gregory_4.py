...
from osprey.graphics.gregory_plot import gregory_plot_january, gregory_plot
...
def drawing(figname):
    ...
    gregory_plot(expname='lfr0', startyear=1990, endyear=2010, varname1='thetao', varname2='qt_oce', reader='nemo', color='red', linestyle='--', marker='o', label='REF')
    gregory_plot(expname='FE05', startyear=1990, endyear=2006, varname1='thetao', varname2='qt_oce', reader='nemo', color='blue', linestyle='-', marker='s', label='EOF-TS')
