...
def drawing(figname):
    ...
    timeseries(expname='lfr0', startyear=1990, endyear=2399, varlabel='thetao', reader='post', metric='relsqerr', color='gray', linestyle='-', label='REF')

    # comparison with EOF experiments
    timeseries(expname='FE01', startyear=1990, endyear=2139, varlabel='thetao', reader='post', metric='relsqerr', color='red', linestyle='-', label='EOF-T')
    timeseries(expname='FE02', startyear=1990, endyear=2089, varlabel='thetao', reader='post', metric='relsqerr', color='blue', linestyle='-', label='EOF-TS')
    ...
    plt.title('Timeseries of relsqerr metric of global mean temperature \n wrt REF [2390-2399] ')
