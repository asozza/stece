...
def drawing(figname):
    ...
    timeseries(expname='lhr4', startyear=1990, endyear=2240, varlabel=varlabel, reader='post', timeoff=1156, color=color, linestyle='-')
    timeseries(expname='lhr5', startyear=1990, endyear=2240, varlabel=varlabel, reader='post', timeoff=1406, color=color, linestyle='-')
