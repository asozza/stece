...
from osprey.graphics.timeseries import timeseries_with_markers
...
def drawing(figname):
    ...
    timeseries_with_markers(expname='lfr0', startyear=1990, endyear=2030, varlabel='thetao', reader='post', color='gray', linestyle='--', marker='o', label='REF')
    timeseries_with_markers(expname='FE01', startyear=1990, endyear=2030, varlabel='thetao', reader='post', color='red', linestyle='-', marker='s', label='EOF-T')
    timeseries_with_markers(expname='FE02', startyear=1990, endyear=2030, varlabel='thetao', reader='post', color='blue', linestyle='-', marker='*', label='EOF-TS')
