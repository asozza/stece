    ...
    if component == 'nemo':
        varlist = {
            ...
            'mldr10_1dcy': {'dim': '2D', 
                            'grid': 'T',
                            'units': 'm', 
                            'long_name': 'Amplitude of MLD Diurnal Cycle'},
            'sbt': {'dim': '2D', 
                    'grid': 'T',
                    'units': 'degC', 
        ...
        varlist = {
            ...
            'clh': {'dim': '2D', 
                    'units': '%', 
                    'long_name': 'High Cloud Cover Percentage'},
            'clm': {'dim': '2D', 
                    'units': '%', 
                    'long_name': 'Medium Cloud Cover Percentage'},
            'cll': {'dim': '2D', 
                    'units': '%', 
                    'long_name': 'Low Cloud Cover Percentage'},
            'alb': {'dim': '2D', 
                    'units': '%', 
