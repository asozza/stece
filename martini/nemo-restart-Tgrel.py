...
if __name__ == "__main__":
    ...
    for var in varlist:
        ...
        trel = (teq-tef[0])/tef[0]
        delta = xr.where(xfield['tn']!=0, xfield0[var].values- xfield[var].values, 0.0)
        yfield[var] = xr.where(delta>0, (1+trel)*xfield[var], (1-trel)*xfield[var])
        xfield[var] = yfield[var]
